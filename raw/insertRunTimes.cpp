...
int main() {
  ...
  // std::cout << "\n" << timeElapsed6 << " seconds have elapsed for the setTree
  // to search for "
  //           << REMOVE_ITERATIONS << " random numbers between 1 and " << MAX
  //           << "." << std::endl;
  // std::cout << "Size of setTree after = " << setTree.size() << "."<<
  // std::endl; std::cout << foundInSet << " elements were found and " <<
  // REMOVE_ITERATIONS-foundInSet << " were not found in the setTree" <<
  // std::endl;
  ...
  // std::cout << "\n" << timeElapsed13 << " seconds have elapsed for the
  // rawRedBlackTree to search for "
  //           << REMOVE_ITERATIONS << " random numbers between 1 and " << MAX
  //           << "." << std::endl;
  // std::cout << "Size of rawRedBlackTree = " << RBT.size() << "." <<
  // std::endl; std::cout << foundInRBT << " elements were found and " <<
  // REMOVE_ITERATIONS-foundInRBT << " were not found in the rawRedBlackTree" <<
  // std::endl;
